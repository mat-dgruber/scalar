...
export const es = {
  ...
  developerTools: {
    ...
    copy: 'Copiar',
    specCopied: 'Especificación OpenAPI copiada al portapapeles',
    linkGenerated: 'Enlace de vista previa generado',
    localExport: 'Exportación local',
    previewLink: 'Enlace de vista previa',
    generatePreviewLink: 'Generar enlace de vista previa',
    previewLinkHint:
      'Vista previa del lado del cliente comprimida en el hash de URL. No se requiere subida al servidor.',
    integrate: 'Integrar',
    integrateTitle: 'Integraciones de Framework',
    integrateDescription: 'Integra Scalar API Reference en tu framework backend o aplicación HTML.',
    frameworkSnippets: 'Fragmentos de Framework',
    internalGuides: 'Guías Internas y Estándares',
  },
  gettingStarted: {

...
export const pt = {
  ...
  developerTools: {
    ...
    downloaded: 'Baixado',
    copy: 'Copiar',
    specCopied: 'Especificação OpenAPI copiada para a área de transferência',
    linkGenerated: 'Link de prévia gerado',
    localExport: 'Exportação Local',
    previewLink: 'Link de Prévia',
    generatePreviewLink: 'Gerar Link de Prévia',
    previewLinkHint: 'Prévia client-side compactada no hash da URL. Nenhum upload em servidor necessário.',
    integrate: 'Integrar',
    integrateTitle: 'Integrações de Framework',
    integrateDescription: 'Integre o Scalar API Reference em seu framework backend ou aplicação HTML.',
    frameworkSnippets: 'Snippets de Framework',
    internalGuides: 'Guias Internos e Padrões',
  },
  gettingStarted: {

...
export const ar = {
  ...
  developerTools: {
    ...
    copy: 'نسخ',
    specCopied: 'تم نسخ مواصفات OpenAPI إلى الحافظة',
    linkGenerated: 'تم إنشاء رابط المعاينة',
    localExport: 'تصدير محلي',
    previewLink: 'رابط المعاينة',
    generatePreviewLink: 'إنشاء رابط المعاينة',
    previewLinkHint: 'معاينة من جانب العميل مضغوطة في عنوان URL. لا يلزم التحميل على الخادم.',
    integrate: 'دمج',
    integrateTitle: 'عمليات تكامل Framework',
    integrateDescription: 'قم بدمج مرجع Scalar API في إطار عمل الخلفية أو تطبيق HTML الخاص بك.',
    frameworkSnippets: 'مقتطفات إطار العمل',
    internalGuides: 'الأدلة والمعايير الداخلية',
  },
  gettingStarted: {

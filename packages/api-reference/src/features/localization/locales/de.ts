...
export const de = {
  ...
  developerTools: {
    ...
    copy: 'Kopieren',
    specCopied: 'OpenAPI-Spezifikation in die Zwischenablage kopiert',
    linkGenerated: 'Vorschau-Link generiert',
    localExport: 'Lokaler Export',
    previewLink: 'Vorschau-Link',
    generatePreviewLink: 'Vorschau-Link generieren',
    previewLinkHint: 'Clientseitige Vorschau komprimiert im URL-Hash. Kein Server-Upload erforderlich.',
    integrate: 'Integrieren',
    integrateTitle: 'Framework-Integrationen',
    integrateDescription: 'Integrieren Sie die Scalar API Reference in Ihr Backend-Framework oder Ihre HTML-Anwendung.',
    frameworkSnippets: 'Framework-Snippets',
    internalGuides: 'Interne Leitfäden & Standards',
  },
  gettingStarted: {

...
export const en = {
  ...
  developerTools: {
    ...
    copy: 'Copy',
    specCopied: 'OpenAPI specification copied to clipboard',
    linkGenerated: 'Preview link generated',
    localExport: 'Local Export',
    previewLink: 'Preview Link',
    generatePreviewLink: 'Generate Preview Link',
    previewLinkHint: 'Client-side preview compressed into URL hash. No server upload required.',
    integrate: 'Integrate',
    integrateTitle: 'Framework Integrations',
    integrateDescription: 'Integrate Scalar API Reference into your backend framework or HTML application.',
    frameworkSnippets: 'Framework Snippets',
    internalGuides: 'Internal Guides & Standards',
  },
  gettingStarted: {

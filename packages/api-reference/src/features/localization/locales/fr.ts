...
export const fr = {
  ...
  developerTools: {
    ...
    copy: 'Copier',
    specCopied: 'Spécification OpenAPI copiée dans le presse-papiers',
    linkGenerated: 'Lien d’aperçu généré',
    localExport: 'Export local',
    previewLink: 'Lien d’aperçu',
    generatePreviewLink: 'Générer le lien d’aperçu',
    previewLinkHint: 'Aperçu côté client compressé dans le hash d’URL. Aucun téléversement sur serveur requis.',
    integrate: 'Intégrer',
    integrateTitle: 'Intégrations de Framework',
    integrateDescription: 'Intégrez Scalar API Reference dans votre framework backend ou application HTML.',
    frameworkSnippets: 'Extraits de Framework',
    internalGuides: 'Guides Internes et Standards',
  },
  gettingStarted: {

...
export const ru = {
  ...
  developerTools: {
    ...
    copy: 'Копировать',
    specCopied: 'Спецификация OpenAPI скопирована в буфер обмена',
    linkGenerated: 'Ссылка для предварительного просмотра создана',
    localExport: 'Локальный экспорт',
    previewLink: 'Ссылка для предварительного просмотра',
    generatePreviewLink: 'Создать ссылку предварительного просмотра',
    previewLinkHint: 'Предварительный просмотр на стороне клиента сжат в URL-хэш. Загрузка на сервер не требуется.',
    integrate: 'Интеграция',
    integrateTitle: 'Интеграции с фреймворками',
    integrateDescription: 'Интегрируйте Scalar API Reference в ваш бэкенд-фреймворк или HTML-приложение.',
    frameworkSnippets: 'Фрагменты фреймворка',
    internalGuides: 'Внутренние руководства и стандарты',
  },
  gettingStarted: {
